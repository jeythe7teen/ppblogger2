...
import { LogOut, PenTool, Shield, LogIn, Search, X, SlidersHorizontal } from 'lucide-react';
...
const Layout = ({ children, user, onLogout }: LayoutProps) => {
  ...
  useEffect(() => {
    ...
    // FIX: Make search data fetching async
        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 h-16 flex items-center justify-between gap-2">
            ...
            <div className="flex-1 flex justify-center px-1 md:px-2 lg:px-8">
               ...
               <div className="md:hidden flex items-center gap-1">
                    <Button variant="ghost" icon={SlidersHorizontal} className="!p-2" onClick={() => setIsFilterModalOpen(true)} title={t('header.filterByAuthor')} />
            ...
            <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0">
                ...
                {user ? (
                    <>
                        ...
                        <Button variant="outline" size="sm" onClick={onLogout} title={t('header.logout')}>
